...
namespace Samples
{
    ...
    public class OrderSamples
    {
        ...
        public static Order WhatIfComboLimitOrder(string action, double quantity, double limitPrice, bool nonGuaranteed)
        {
            // ! [whatiflimitorder]
            Order order = ComboLimitOrder(action, quantity, limitPrice, nonGuaranteed);
            order.WhatIf = true;
            // ! [whatiflimitorder]
            return order;
        }
