...
namespace Samples
{
    ...
    public class ContractSamples
    {
        ...
        public static Contract Contract_RT (string symbol, string sectype, string exchange)
        {
            //! [indcontract]
        ...
        public static Contract Contract_FUT(string symbol, string sectype, string expiration, string exchange)
        {
            //! [indcontract]
            Contract contract = new Contract();
            contract.Symbol = symbol;
        ...
        public static Contract Contract_Options(string symbol, string sectype, string expiration, string right, double strike, string multiplier, string exchange)
        {
        ...
        public static Contract Contract_Combo (string symbol, string sectype, string expiration, string right, int leg1_id, int leg2_id, string multiplier, string exchange)
        {
            //! [bagfutcontract]
            Contract contract = new Contract();
            contract.Symbol = symbol;
            contract.SecType = "BAG";  // always BAG
            contract.Currency = "USD";
            contract.Exchange = exchange;
            contract.LastTradeDateOrContractMonth = expiration;
            contract.Right = right;
    ...
    public static Contract SP_Index()
        {
            //! [indcontract]
            Contract contract = new Contract();
            contract.Symbol = "SPX";
        ...
        public static Contract Index_Options(string symbol, string expiration, string right, int strike, string multiplier, string exchange)
        {
        ...
        public static Contract SP_Index_Options()
        {
            ...
            contract.Right = "P";
            contract.Strike = 2790;
            contract.Multiplier = "100";
            return contract;
        }

        public static Contract FuturesOnOptions(string symbol, string expiration, string right, int strike, string multiplier, string exchange)
        {
            //! [fopcontract]
            Contract contract = new Contract();
            contract.Symbol = symbol;
        ...
        public static Contract FuturesOnOptionsES()
        {
            //! [fopcontract]
            Contract contract = new Contract();
            contract.Symbol = "ES";
   ...
   /*
  * ES Future combo contract
  * Leg 1: 195538625 - FUT expiring 2018/09/07
  * Leg 2: 197436571 - FUT expiring 2018/09/07
  */
        public static Contract FutureComboES()
        {
            //! [bagfutcontract]
            Contract contract = new Contract();
            contract.Symbol = "ES";
            ...
            contract.Currency = "USD";
            contract.Exchange = "GLOBEX";
            contract.LastTradeDateOrContractMonth = "20180831";
            contract.Right = "P";
            contract.Multiplier = "50";

            ComboLeg leg1 = new ComboLeg();
            leg1.ConId = 310738135;//ES FUT 20180831
            leg1.Ratio = 1;
            leg1.Action = "BUY";
            leg1.Exchange = "GLOBEX";

            ComboLeg leg2 = new ComboLeg();
            leg2.ConId = 309262514;//ES FUT 2018/08/31
            leg2.Ratio = 1;
            leg2.Action = "SELL";
            leg2.Exchange = "GLOBEX";
        ...
        * to prevent abuse.
        */
        public static Contract ESOptionForQuery()
        {
            //! [optionforquery]
            Contract contract = new Contract();
            contract.Symbol = "ES";
